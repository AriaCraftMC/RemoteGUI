...
public class RemoteGUIApi {
    ...
    public static void showRemotePlayerGui(String target, CallableGUI gui) {
        try {
            RemoteGUICommon.getCommon().getMqEasyPlugin().getApi().sendMessageToPlayerNoReturn(target,MQEasyJsonUtil.parseObject(
    ...
    public static void closeRemotePlayerGui(String target) {
        try {
            RemoteGUICommon.getCommon().getMqEasyPlugin().getApi().sendMessageToPlayerNoReturn(target,
